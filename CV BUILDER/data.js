...
const validType = {
 ...
 let firstnameElem = mainForm.firstname,
    ...
    let nameDsp = document.getElementById('fullname_dsp'),
        ...
        experienceDsp = document.getElementById('experience_dsp');
...
const fetchValues = (attrs,  ...nodeLists) => {
 ...
 for(let i = 0; i < elemsDataCount; i++){
    ...
    for(let j = 0; j < elemsAttrsCount; j++){
        ...
        dataObj['${attrs[j]}'] = nodeLists[j].value;
    }
 ...
 const getUserInputs = () => {
  //----------------achievements------------------
    ...
    emailElemElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.EMAIL,'Email'));
    ...
    expStartDateElem.forEach(item =>item.addEventListener('keyup',(e) =>
    ...
    eduCityElemElem.forEach(item =>item.addEventListener('keyup',(e) =>
    validateFormData(e.target, validType.ANY, 'City')));
    eduStartDateElem.forEach(item =>item.addEventListener('keyup',(e) =>
    validateFormData(e.target, validType.ANY, 'Title')));
 ...
 return{
        ...
        educations: fetchValues(['edu_school','edu_degree','edu_city','edu_start_date','edu_graduation_date','edu_description'],eduSchoolElem,
        eduDegreeElem, eduCityElem, eduStartDateElem, eduGraduationDateElem,eduDescriptionElem),
        projects: fetchValues(['proj_title','proj_link','proj_description'],
         projTitleElem, projLinkElem, projDescription),
 ...
 const showListData = (listData, listContainer) => {
   ...
   listData.forEach(listItem =>{
       ...
       for(const key in listItem){
         ...
         subItemElem.classList.add('preview-item');
